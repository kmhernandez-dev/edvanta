/**
 * ============================================================
 *  FREE_GUIDES — Links de las guías gratis (Feliz Sin Tiroides)
 *
 *  Sube tus PDFs/recursos a Drive, Dropbox, etc. y pega el
 *  link público en `url`. Cuando todos los urls estén
 *  configurados, el correo al visitante los incluirá.
 * ============================================================
 */
