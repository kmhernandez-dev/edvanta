import { WHATSAPP_URL, EMAIL, LINKEDIN_URL, BRAND_FULL } from '../config/links';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <div>
                <p className="text-sm font-bold text-navy-950 leading-none">Biblioteca Profesional KH</p>
              </div>
            </div>
            <p className="text-sm text-gray-500 leading-relaxed mb-4">
              Productos digitales, plantillas profesionales y rutas de aprendizaje para crecer en tu carrera.
            </p>
        ...
        <div className="border-t border-gray-200 pt-6 space-y-3">
          ...
          <p className="text-xs text-gray-400 leading-relaxed max-w-3xl">
            ⚠️ Algunos enlaces pueden corresponder a cursos afiliados de Edutin Academy. La disponibilidad, condiciones del certificado y precios pueden variar según la plataforma externa. Los contenidos de los packs son de elaboración propia y no representan a ninguna institución oficial.
          </p>
          <p className="text-xs text-gray-400">
            © {year} {BRAND_FULL}. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
