...
// Los nombres y descripciones viven en catalogo.js para que la galería de la
// herramienta pueda listarlos sin cargar todo el código de dibujo de abajo.
export { PLANTILLAS, plantillaPorId, esEstiloPlantilla } from './catalogo.js';
