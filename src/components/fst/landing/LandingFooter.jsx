...
import { EMAIL, FST_COMMUNITY_URL, waLink } from '../../../config/links';
...
export default function LandingFooter() {
  ...
  return (
    <footer className="bg-[#132e55] text-white">
        ...
        <div className="grid gap-10 border-b border-white/15 pb-10 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <a href={FST_COMMUNITY_URL} target="_blank" rel="noopener noreferrer" onClick={() => trackEvent('whatsapp_click', { location: 'landing_footer_comunidad' })} className="inline-flex min-h-11 items-center gap-2 rounded-md border border-white/25 px-4 text-sm font-semibold hover:bg-white/10">
                <Icon name="users" className="h-4 w-4" /> Comunidad
              </a>
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" onClick={() => trackEvent('whatsapp_click', { location: 'landing_footer' })} className="inline-flex min-h-11 items-center gap-2 rounded-md border border-white/25 px-4 text-sm font-semibold hover:bg-white/10">
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-[#d8c5e8]">Empieza aquí</p>
            <nav className="mt-4 space-y-3 text-sm text-white/70">
              <Link to="/feliz-sin-tiroides" className="block hover:text-white">Inicio</Link>
              <Link to="/recursos-tiroides" className="block hover:text-white">Recursos digitales</Link>
              <Link to="/atencion-farmaceutica" className="block hover:text-white">Atención Farmacéutica</Link>
              <Link to="/feliz-sin-tiroides#fst-recursos" className="block hover:text-white">Recursos gratuitos</Link>
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-[#d8c5e5]">Legal</p>
            <nav className="mt-4 space-y-3 text-sm text-white/70">
