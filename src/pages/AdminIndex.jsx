      ...
      <main className="min-h-screen bg-edvanta-bg">
        <section className="border-b border-slate-200 bg-white">
          <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
            ...
            <h1 className="mt-2 text-3xl font-bold text-edvanta-deep sm:text-4xl">Paneles administrativos</h1>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {PANELS.map(panel => (
              ...
              >
                ...
                <h2 className="mt-4 text-lg font-bold text-edvanta-deep group-hover:text-teal-800">{panel.title}</h2>
