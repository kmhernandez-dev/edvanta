...
const VACANTES_DEMO = [
  {
    ...
    empresa: 'IBUPLI PHARMA S.A.S.',
    ciudad: 'Barranquilla',
    modalidad: 'Presencial',
    requisitos: 'Asuntos regulatorios, trámites INVIMA, registros sanitarios, renovaciones, CVL y CPP, BPM y documentación técnica. Sin años de experiencia exigidos explícitamente. Salario: $2.500.000 a $3.000.000.',
    contacto: 'https://www.elempleo.com/co/ofertas-trabajo/quimico-farmaceutico-asuntos-regulatorios-y-produccion-1886754499',
    fuente: 'Elempleo (confirmado también en Jooble)',
    fecha: '2026-08-20',
  },
  {
    id: 'demo-2',
    cargo: 'Químico farmacéutico hospitalario - farmacovigilancia y atención farmacéutica',
    empresa: 'ESTRATEGICA MM',
    ciudad: 'Colombia (ciudad por confirmar)',
    modalidad: 'Presencial',
    requisitos: 'Farmacovigilancia, tecnovigilancia, atención farmacéutica, PROA, reporte de eventos adversos, manejo de kit de urgencias y visitas de IVC. Salario: $2.730.000. Nivel y experiencia: por verificar en la publicación.',
    contacto: 'https://co.jooble.org/desc/-2307805742444191422',
    fuente: 'Jooble',
    fecha: '2026-08-18',
  },
  {
    id: 'demo-3',
    cargo: 'Químico farmacéutico - área asistencial',
    empresa: 'Empresa confidencial',
    ciudad: 'Barranquilla',
    modalidad: 'Presencial',
    requisitos: 'Área asistencial. Experiencia mínima de 1 año. Salario bruto anual publicado: $35 millones.',
    contacto: 'https://empleo.trovit.com.co/empleo-qu%C3%ADmico-farmaceutico-en-barranquilla,-atl%C3%A1ntico',
    fuente: 'Trovit / Mipleo',
    fecha: '2026-08-18',
  },
  {
    id: 'demo-4',
    cargo: 'Coordinador de calidad y laboratorio fisicoquímico',
    empresa: 'GESTION Y SERVICIOS AMBIENTALES S.A.S.',
    ciudad: 'Medellín, Barranquilla, Bogotá, Cartagena, Bucaramanga y área metropolitana',
    modalidad: 'Presencial',
    requisitos: 'NTC-ISO/IEC 17025, ISO 9001, ISO 14001, sistemas integrados de gestión, auditorías internas, matriz legal y gestión documental. Experiencia mínima de 2 años. Salario a convenir.',
    contacto: 'https://www.magneto365.com/co/empleos/quimico-puro-quimico-farmaceutico-1024305',
    fuente: 'Magneto365',
    fecha: '2026-08-14',
  },
  {
    id: 'demo-5',
    cargo: 'Químico farmacéutico - área asistencial hospitalaria',
    empresa: 'Empresa confidencial',
    ciudad: 'Barranquilla',
    modalidad: 'Presencial',
    requisitos: 'Abierta a recién egresados: experiencia mínima de 6 meses en el cargo, documentación al día. Salario bruto anual publicado: $36 millones.',
    contacto: 'https://empleo.trovit.com.co/empleo-qu%C3%ADmico-farmaceutico-en-barranquilla,-atl%C3%A1ntico',
    fuente: 'Trovit / Mipleo',
    fecha: '2026-08-15',
  },
  {
    id: 'demo-6',
    cargo: 'Químico farmacéutico - control de calidad (industria química)',
    empresa: 'Empresa confidencial',
    ciudad: 'Barranquilla',
    modalidad: 'Presencial',
    requisitos: 'Control de calidad en sector químico. Experiencia mínima de 2 años. Salario bruto anual publicado: $32 millones.',
    contacto: 'https://empleo.trovit.com.co/empleo-qu%C3%ADmico-farmaceutico-en-barranquilla,-atl%C3%A1ntico',
    fuente: 'Trovit / Mipleo',
    fecha: '2026-08-15',
  },
