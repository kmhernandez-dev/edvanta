      ...
      <main className="bg-white">
        ...
        <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-1 text-2xl font-bold text-edvanta-deep">¿Qué necesitas resolver hoy?</h2>
          </div>
            ...
            {entryPoints.map((item) => {
              ...
              return (
                <Link key={item.to} to={item.to} className="group grid min-h-40 gap-4 rounded-lg border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-teal-300 hover:shadow-md sm:grid-cols-[48px_minmax(0,1fr)]">
                  ...
                  <span>
                    <span className="block text-lg font-bold text-edvanta-deep">{item.title}</span>
        ...
        <section className="border-y border-slate-200 bg-edvanta-bg">
        ...
        <section className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <h2 className="mt-4 text-2xl font-bold text-edvanta-deep">Cursos con contexto profesional</h2>
